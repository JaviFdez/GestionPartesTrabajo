...
namespace GestionPartesTrabajo.Nunsys.WebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private IUsers1Service _usersService = null;
        ...
        public AccountController( AuthRepository authRepository, IUsers1Service usersService)
        {
        ...
        public async Task<IHttpActionResult> Register(UserModel userModel)
        {
            ...
            Task<IdentityUser> user = this._authRepository.FindAsync(userModel.UserName, userModel.Password);

            UserDto userDto = new UserDto
            {
                Name = userModel.UserName,
                IdNetUser = user.Id.ToString()
            };

            this._usersService.saveUser(userDto);
